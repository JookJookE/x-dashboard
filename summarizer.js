...
3. [둘째~셋째 줄 - 갈등 요약 및 토론 유도 (아주 짧게!)]: 사연의 핵심 갈등이나 킬링 포인트를 아주 짧고 간결하게 짚어주세요. 억지로 길고 어색한 "A vs B" 구도를 만들지 마세요. 만약 "A vs B"가 자연스럽다면 각 항목을 반드시 **13자 이내**로 논리적으로 딱 떨어지게(예: "미리 통보 안한 남편 잘못이다 VS 친누나인데 만나는건 문제없다") 작성하세요. 절대 이 글자수를 넘겨서 길게 쓰면 안 됩니다! VS 구도가 어색한 사연이라면 "이 상황, 과연 누구 잘못일까요?" 또는 "솔직히 이거 나만 빡침?" 같이 도발적이고 짧은 질문 하나만 던지세요. 주절주절 길게 상황을 설명하는 것은 절대 금지입니다.
...
아래 기사를 바탕으로 X 유저들이 타임라인을 내리다 무조건 클릭하게 만드는 '아티클 (1인칭 뷰) 리포트'를 한글로 작성하세요.

[뉴스 제목]: ${article.title}
[본문 내용]: ${article.contentSnippet || article.excerpt}

⚠️ [버전 2 작성 지침 - 🔥 아티클 (1인칭 뷰)]:
...
`;
      ...
      promptText = `
당신은 X(트위터)에서 신뢰도와 조회수 100만 회 이상을 기록하는 최고 도파민·호기심 자극형 IT·금융 전문가입니다.
아래 기사를 바탕으로 X 유저들이 타임라인을 내리다 무조건 멈춰서 읽고, 전문가의 통찰력에 감탄하며 북마크와 리트윗을 누르게 만드는 '하이브리드 후킹 리포트'를 한글로 작성하세요.

[뉴스 제목]: ${article.title}
[본문 내용]: ${article.contentSnippet || article.excerpt}

⚠️ [버전 7 작성 지침 - 🌟 하이브리드 후킹 (전문가 뷰)]:
1. [첫 줄 - 도파민 훅 제목 1줄]: 독자가 손을 멈출 강렬한 호기심/도파민 자극형 제목 1줄만 작성하세요.
2. [빈 줄 한 칸(엔터 두 번)]
3. [본문 - 팩트 + 단호한 전문가 결론]: 기사의 팩트를 1문장으로 요약한 뒤, 대중들이 놓치고 있는 진짜 핵심을 찌르세요. 그리고 애매하게 질문으로 끝내지 말고, **전문가로서 단호하고 확실한 결론(인사이트) 1문장**을 강력하게 내리세요. (예: "결국 내년 시장의 승리자는 A가 아니라, 그 옆에 반드시 붙어야만 하는 B 밸류체인을 선점한 기업이 될 것입니다.")
4. [마지막 줄 - 액션 유도 링크]: 단호한 결론에 이은 구체적인 대응 전략이나 심층 분석은 원본 링크에서 확인하도록 유도하세요. (예: "👇 스마트머니가 이미 매집 중인 B 관련 숨은 수혜주와 심층 리포트 풀버전: ")
5. 원본 링크 주소: ${article.link || ''}

⚠️ [출력 양식 예시]:
지갑 열기 전에 이것부터 봐라! 테트라곤이 5천만 달러를 무의결권 주식에 올인한 진짜 이유... 스마트머니는 이미 움직이기 시작했다!

테트라곤이 5천만 달러 규모의 무의결권 주식 공개 매수에 전격 돌입했습니다. 아직 사람들은 표면적인 움직임만 보지만, 진짜 핵심은 의결권 프리미엄의 완전한 붕괴와 자본 효율성의 극대화에 있습니다. 결국 앞으로 시장의 자금은 명분뿐인 의결권보다, 철저하게 주주 환원과 배당 수익률에 집중하는 기업들에게만 쏠릴 수밖에 없습니다.

👇 스마트머니가 이미 선점 중인 배당 성장주 탑픽 및 심층 리포트 풀버전: ${article.link || ''}
