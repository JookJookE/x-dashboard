...
3. [둘째~셋째 줄 - 갈등 요약 및 토론 유도 (아주 짧게!)]: 사연의 핵심 갈등이나 킬링 포인트를 아주 짧고 간결하게 짚어주세요. 억지로 길고 어색한 "A vs B" 구도를 만들지 마세요. 만약 "A vs B"가 자연스럽다면 각 항목을 반드시 **8자 이내**로 아주 짧고 강렬하게(예: "미리 통보 안함 VS 굳이 밖에서 만남") 작성하세요. 절대 길게 쓰면 안 됩니다! VS 구도가 어색한 사연이라면 "이 상황, 과연 누구 잘못일까요?" 또는 "솔직히 이거 나만 빡침?" 같이 도발적이고 짧은 질문 하나만 던지세요. 주절주절 길게 상황을 설명하는 것은 절대 금지입니다.
