...
async function fetchLatestArticles(limit = 35, customScanTime = null) {
  ...
  try {
    const [
      ...
      fetchNewsRssArticles('pann', '("네이트판" OR "사연") (파혼 OR 상견례 OR 축의금 OR "어떻게 생각" OR 이혼 OR 갈등 OR 시댁 OR 남친 OR 여친) -(연예 OR 방송 OR 배우 OR 아이돌 OR 예능)', '네이트판', '⚖️ 네이트판 / 사연', 6, scanBatchTime),
